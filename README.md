...
**Quantity:**
 ...
 The number of units of the product that were sold in the transaction.
This helps calculate total sales and understand product demand by looking at the quantities purchased.
...
**Customer Segmentation using PYOD**
